...
public class PreventConcurrentJobLauncher {
    ...
    public String getClusterIdFromExecution(JobExecution jobExecution) {
        ...
        if (params.containsKey(it.govpay.iban.batch.Costanti.GOVPAY_BATCH_JOB_PARAMETER_CLUSTER_ID)) {
            return params.get(it.govpay.iban.batch.Costanti.GOVPAY_BATCH_JOB_PARAMETER_CLUSTER_ID)
                .getValue().toString();
        }
