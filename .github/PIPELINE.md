...
3. Verifica che il projectKey sia: `link-it_govpay-iban-batch`
...
### OpenAPI Generator
- **Versione:** 7.10.0
- **Spec:** `src/main/resources/openapi/iban_organization.json`
- **Output:** `target/generated-sources/openapi/`
- **Package:** `it.govpay.iban.client.*`
...
```markdown
[![Java CI with Maven](https://github.com/link-it/govpay-iban-batch/actions/workflows/maven.yml/badge.svg)](https://github.com/link-it/govpay-iban-batch/actions/workflows/maven.yml)
...
[![Coverage](https://sonarcloud.io/api/project_badges/measure?project=link-it_govpay-iban-batch&metric=coverage)](https://sonarcloud.io/summary/new_code?id=link-it_govpay-iban-batch)
```
